...
function preload(){
  ...
  kangaroo_correct_running =   loadAnimation("assets/kangaroo3.png","assets/kangaroo1.png","assets/kangaroo2.png");
...
function reset(){
  ...
  kangoroo.changeAnimation("correct_running",kangaroo_correct_running);
